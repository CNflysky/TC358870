#ifndef _VVX10F034N00_H_
#define _VVX10F034N00_H_
#include "tc358870_i2c.h"

#define POWER_ON_DELAY 10
// since there is no external reset pin of this panel,we just need to sleep for
// 500ms.
#define RESET_LOW_TIME 250
#define RESET_HIGH_TIME 250
#define BACKLIGHT_TURN_ON_DELAY 90
...
void RS1() {
  ...
  i2c1_uh2cd_write8(0x8C36, 0x38);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C37, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C38, 0x80);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C39, 0xE0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C3A, 0x70);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C3B, 0xB0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C3C, 0x4E);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C3D, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C3E, 0x98);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C3F, 0x34);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C40, 0x86);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C41, 0x04);  // EDID_RAM
  ...
  i2c1_uh2cd_write8(0x8C48, 0x38);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C49, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C4A, 0x80);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C4B, 0xE0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C4C, 0x70);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C4D, 0xB0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C4E, 0x4E);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C4F, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C50, 0x98);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C51, 0x34);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C52, 0x86);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C53, 0x04);  // EDID_RAM
  ...
  i2c1_uh2cd_write8(0x8C7F, 0x05);  // EDID_RAM
  ...
  i2c1_uh2cd_write8(0x8C9A, 0x38);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C9B, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C9C, 0x80);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C9D, 0xE0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C9E, 0x70);  // EDID_RAM
  i2c1_uh2cd_write8(0x8C9F, 0xB0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CA0, 0x4E);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CA1, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CA2, 0x98);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CA3, 0x34);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CA4, 0x86);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CA5, 0x04);  // EDID_RAM
  ...
  i2c1_uh2cd_write8(0x8CAC, 0x38);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CAD, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CAE, 0x80);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CAF, 0xE0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CB0, 0x70);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CB1, 0xB0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CB2, 0x4E);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CB3, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CB4, 0x98);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CB5, 0x34);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CB6, 0x86);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CB7, 0x04);  // EDID_RAM
  ...
  i2c1_uh2cd_write8(0x8CBE, 0x38);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CBF, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC0, 0x80);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC1, 0xE0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC2, 0x70);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC3, 0xB0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC4, 0x4E);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC5, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC6, 0x98);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC7, 0x34);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC8, 0x86);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CC9, 0x04);  // EDID_RAM
  ...
  i2c1_uh2cd_write8(0x8CD0, 0x38);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CD1, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CD2, 0x80);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CD3, 0xE0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CD4, 0x70);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CD5, 0xB0);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CD6, 0x4E);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CD7, 0x40);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CD8, 0x98);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CD9, 0x34);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CDA, 0x86);  // EDID_RAM
  i2c1_uh2cd_write8(0x8CDB, 0x04);  // EDID_RAM
  ...
  i2c1_uh2cd_write8(0x8CFF, 0xBB);  // EDID_RAM
  // HDCP Setting
  // HDMI SYSTEM
...
void Panel_Init() {
  ...
  i2c1_uh2cd_write16(0x0504, 0x0032);  // DCSCMD_Q
  // Waitx1ms(120);
  // // Soft Reset
  // i2c1_uh2cd_write16(0x0504, 0x0005);  // DCSCMD_Q
...
void RS3() {
  ...
  i2c1_uh2cd_write32(0x0170, 0x0000060B);  // APF_VDELAYCNT
  i2c1_uh2cd_write32(0x017C, 0x00000081);  // DSI_TX_MODE
  i2c1_uh2cd_write32(0x018C, 0x0000009C);  // DSI_HSYNC_WIDTH
  i2c1_uh2cd_write32(0x0190, 0x000000D8);  // DSI_HBPR
  ...
  i2c1_uh2cd_write16(0x5008, 0x1680);  // STX0_WC
  i2c1_uh2cd_write16(0x5088, 0x1680);  // STX1_WC
  // Enable Interrupt
  i2c1_uh2cd_write8(0x8502, 0xFF);     // SYS_INT
